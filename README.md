...
# Cách 2: chia key thành 3 phần (khuyên dùng khi deploy)
GEMINI_API_KEY_P1=...
GEMINI_API_KEY_P2=...
GEMINI_API_KEY_P3=...
GEMINI_API_KEY_BACKUP_P1=...
GEMINI_API_KEY_BACKUP_P2=...
GEMINI_API_KEY_BACKUP_P3=...
...
- Tab Community cập nhật liên tục theo polling 2.5 giây/lần (chỉ khi tab Community đang mở và tab trình duyệt visible).
